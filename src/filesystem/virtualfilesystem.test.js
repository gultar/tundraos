...
describe('Virtual File System Validations methods', ()=> {
  ...
  describe('isDir()', ()=> {
    ...
    it('Should also say if it is a file', ()=>{
      assert.equal(filesystem.isDir(root.directory.file), false)
  });
  });
});
...
describe("Virtual File System Bash Command methods", ()=>{
  ...
  describe("touch()", ()=>{
    it("Should create a new file", ()=>{
      ...
      assert.equal(isCreated, true)
      const testJson = filesystem.wd().files["test.json"]
    ...
    it("Should create a new file in child directory", ()=>{
      ...
      assert.equal(isCreated, true)
      const anotherJson = filesystem.wd().directory.files["anotherFile.json"]
    ...
    it("Should create a new file in parent directory", ()=>{
      ...
      assert.equal(isCreated, true)
      const parentFileJson = filesystem.wd().parent().files["parentFile.json"]
  ...
  describe("cat()", ()=>{
    it("Should output file content", ()=>{
      ...
      filesystem.wd().getFile("smallfile").content = "This is a file" 
